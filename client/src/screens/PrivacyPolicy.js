...
export default function PrivacyPolicy() {
  return (
    <div className="container">
      <h1>Privacy Policy for Excel Exam</h1>

      <p>
        At Excel Exam, accessible from https://excelexam.herokuapp.com/, one of
      ...
      <p>
        ...
        shared and/or collect in Excel Exam. This policy is not applicable to
      ...
      <p>
        Excel Exam follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Excel Exam uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of Excel Exam.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Excel Exam, which are sent
      ...
      <p>
        Note that Excel Exam has no access to or control over these cookies that
      ...
      <p>
        Excel Exam's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Excel Exam does not knowingly collect any Personal Identifiable
